...
STATE_SPACE_N = 71
# ACTIONS dictionary is removed as we are using MultiBinary action space now.
# The keys are now represented by the action array indices: 0:Q, 1:W, 2:O, 3:P
KEYS = ['q', 'w', 'o', 'p']
...
class QWOPEnv(gym.Env):
    ...
    def __init__(self, port, render_mode=None):
        ...
        self.action_space = spaces.MultiBinary(4)  # Changed to MultiBinary
    ...
    def step(self, action):
        # The action is a MultiBinary array, e.g., [1, 0, 1, 0]
